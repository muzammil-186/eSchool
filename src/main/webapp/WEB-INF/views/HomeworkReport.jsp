...
<header id="header">
	...
	<div id="container">
		...
		<spacer type="horizontal" width="100" height="100"></spacer>
		<form action="<%= request.getContextPath()%>/HomeworkReportServlet" method="post">
			...
			<table style="width: 80%">
				...
				<tr>
    				<td>Assignment Date (MM/DD/YYYY)</td>
    				<td><input type="text" name="assigndate" maxlength="10"/></td>
				</tr>
