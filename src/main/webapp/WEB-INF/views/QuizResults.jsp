...
<form action="<%= request.getContextPath()%>/QuizResultsServlet" method="post">
    ...
    <tr>
   	...
   	<c:forEach items="${requestScope.results}" var="result">
	    <tr>
		    ...
		    <td><c:out value="${result.parentId}"></c:out></td>
		    <td><c:out value="${result.grade}"></c:out></td>
		    <td><c:out value="${result.resultGrade}"></c:out></td>
		    <td><c:out value="${result.subject}"></c:out></td>
		    <td><c:out value="${result.examType}"></c:out></td>
		    <td><c:out value="${result.examDate}"></c:out></td>
