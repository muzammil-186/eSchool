...
<header id="header">
	...
	<main id="center" class="column">
			<article>
				<h1>Faculty</h1>
				<p>Here faculty members can assign grades, assignments and place course recordings for students</p>
			</article>	
		...
		<nav id="left" class="column">
			...
			<ul>
				<li><a href="AddQuizResultController">Add Grades</a></li>
				<li><a href="ParentViewGradesController">Grades Report</a></li>
				<li><a href="HomeworkServlet">Add Assignments</a></li>
				<li><a href="HomeworkReportServlet">Assignments Report</a></li>
				<li><a href="#">Add Class Recordings</a></li>
